...
?>
    ...
    <div class="container">
        ...
        <div style=" width:100%; border: 1px solid black; margin-bottom : 10px; float : left">
            <form style="float : left" action="supplierManagement.php" method="post">
                        ...
                        <div class="col-md-12" style="margin: 10px">
                            ...
                            <div class="col-md-4">
                                <input type="text" class="form-control" id="supplier_name" name="supplier_name"
                                    value="<?php 
									if (isset($_POST['update'])) {
									echo $single_row["name"]; }?>" placeholder="Enter Supplier Name">
                            </div>
                        ...
                        <div class="col-md-12" style="margin: 10px">
                            ...
                            <div class="col-md-4">
                                <input class="form-check-input" type="radio" name="visible" id="visible" value=1
									...
									echo ($single_row["is_hidden"] == 'f') ? 'checked' : '';} ?>>
                            ...
                            <div class="col-md-4">
                                <input class="form-check-input" type="radio" name="visible" id="visible" value=0
                                    <?php if (isset($_POST['update'])) { echo ($single_row["is_hidden"] == 't') ? 'checked' : '';} ?>>
                                <label class="form-check-label" for="visible">
                                    Hidden
                                </label>
                            </div>
